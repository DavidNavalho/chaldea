...
const _$SvtClassEnumMap = {
  ...
  SvtClass.uOlgaMarieGrand: 'uOlgaMarieGrand',
  SvtClass.unBeastOlgaMarie: 'unBeastOlgaMarie',
  SvtClass.uOlgaMarieStellar: 'uOlgaMarieStellar',
  SvtClass.beastVIIUnknown: 'beastVIIUnknown',
  SvtClass.beastVII: 'beastVII',
  SvtClass.aquaFragment: 'aquaFragment',
  ...
  SvtClass.uOlgaMarieGrandCollection: 'uOlgaMarieGrandCollection',
  ...
  SvtClass.grandShielder: 'grandShielder',
  SvtClass.grandRuler: 'grandRuler',
  SvtClass.grandAlterego: 'grandAlterego',
  SvtClass.grandAvenger: 'grandAvenger',
  SvtClass.grandMoonCancer: 'grandMoonCancer',
  SvtClass.grandForeigner: 'grandForeigner',
  SvtClass.grandPretender: 'grandPretender',
  SvtClass.grandUnBeastUOlgaMarieAlienGod: 'grandUnBeastUOlgaMarieAlienGod',
  SvtClass.grandUnBeastDraco: 'grandUnBeastDraco',
  SvtClass.grandUnBeastEresh: 'grandUnBeastEresh',
  SvtClass.grandUnBeastUOlgaMarie: 'grandUnBeastUOlgaMarie',
...
const _$CondTypeEnumMap = {
  ...
  CondType.battleValueAbove: 'battleValueAbove',
  CondType.battleValueBelow: 'battleValueBelow',
  CondType.battleValueEqual: 'battleValueEqual',
  CondType.battleValueNotEqual: 'battleValueNotEqual',
  CondType.battlePointEqual: 'battlePointEqual',
  CondType.battlePointNotEqual: 'battlePointNotEqual',
  CondType.battleEntryPlayerTotalCountAbove: 'battleEntryPlayerTotalCountAbove',
  CondType.battleEntryPlayerTotalCountBelow: 'battleEntryPlayerTotalCountBelow',
  CondType.battleEntryPlayerTotalCountEqual: 'battleEntryPlayerTotalCountEqual',
