...
part of '../../../models/gamedata/mst_tables.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserItemEntity _$UserItemEntityFromJson(Map json) => UserItemEntity(itemId: json['itemId'], num: json['num']);
...
TblUserEntity _$TblUserEntityFromJson(Map json) =>
    TblUserEntity(userId: json['userId'], friendPoint: json['friendPoint']);
...
UserEquipEntity _$UserEquipEntityFromJson(Map json) =>
    UserEquipEntity(id: json['id'], equipId: json['equipId'], lv: json['lv'], exp: json['exp']);
...
UserSupportDeckEntity _$UserSupportDeckEntityFromJson(Map json) =>
    UserSupportDeckEntity(userId: json['userId'], supportDeckId: json['supportDeckId'], name: json['name']);
...
UserEventRandomMissionEntity _$UserEventRandomMissionEntityFromJson(Map json) => UserEventRandomMissionEntity(
  userId: json['userId'],
  missionId: json['missionId'],
  missionTargetId: json['missionTargetId'],
  status: json['status'],
...
EventTradeResultInfo _$EventTradeResultInfoFromJson(Map json) =>
    EventTradeResultInfo(tradeGoodsId: json['tradeGoodsId'], getNum: json['getNum']);
...
UserEventRaidEntity _$UserEventRaidEntityFromJson(Map json) =>
    UserEventRaidEntity(userId: json['userId'], eventId: json['eventId'], day: json['day'], damage: json['damage']);
...
UserFollowerEntity _$UserFollowerEntityFromJson(Map json) => UserFollowerEntity(
  followerInfo:
      (json['followerInfo'] as List<dynamic>?)
...
UserAccountLinkageEntity _$UserAccountLinkageEntityFromJson(Map json) =>
    UserAccountLinkageEntity(userId: json['userId'], type: json['type'], linkedAt: json['linkedAt']);
...
BattleInfoData _$BattleInfoDataFromJson(Map json) => BattleInfoData(
  ...
  enemyDeck:
      (json['enemyDeck'] as List<dynamic>?)
          ?.map((e) => DeckData.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  callDeck:
      (json['callDeck'] as List<dynamic>?)
          ?.map((e) => DeckData.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  shiftDeck:
      (json['shiftDeck'] as List<dynamic>?)
          ?.map((e) => DeckData.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  raidInfo:
      (json['raidInfo'] as List<dynamic>?)
          ?.map((e) => BattleRaidInfo.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  startRaidInfo:
      (json['startRaidInfo'] as List<dynamic>?)
          ?.map((e) => BattleRaidInfo.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
