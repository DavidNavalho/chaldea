...
ServantExtra _$ServantExtraFromJson(Map json) => ServantExtra(
  ...
  obtains:
      (json['obtains'] as List<dynamic>?)?.map((e) => $enumDecode(_$SvtObtainEnumMap, e)).toList() ??
  ...
  mcProfiles:
      (json['mcProfiles'] as Map?)?.map(
        (k, e) => MapEntry(int.parse(k as String), (e as List<dynamic>).map((e) => e as String).toList()),
      ) ??
      const {},
  fandomProfiles:
      (json['fandomProfiles'] as Map?)?.map(
        (k, e) => MapEntry(int.parse(k as String), (e as List<dynamic>).map((e) => e as String).toList()),
      ) ??
      const {},
  tdAnimations:
      (json['tdAnimations'] as List<dynamic>?)
...
BiliVideo _$BiliVideoFromJson(Map json) =>
    BiliVideo(av: (json['av'] as num?)?.toInt(), p: (json['p'] as num?)?.toInt(), bv: json['bv'] as String?);
...
EventExtraFixedItems _$EventExtraFixedItemsFromJson(Map json) => EventExtraFixedItems(
  ...
  detail: json['detail'] == null
      ? null
      : MappingBase<String>.fromJson(Map<String, dynamic>.from(json['detail'] as Map)),
  items: (json['items'] as Map?)?.map((k, e) => MapEntry(int.parse(k as String), (e as num).toInt())),
);
...
EventExtra _$EventExtraFromJson(Map json) => EventExtra(
  ...
  extraFixedItems:
      (json['extraFixedItems'] as List<dynamic>?)
  ...
  extraItems:
      (json['extraItems'] as List<dynamic>?)
          ...
          .toList() ??
      const [],
  script: json['script'] == null ? null : EventExtraScript.fromJson(Map<String, dynamic>.from(json['script'] as Map)),
  startTime: json['startTime'] == null
      ? null
      : MappingBase<int>.fromJson(Map<String, dynamic>.from(json['startTime'] as Map)),
  endTime: json['endTime'] == null
      ? null
      : MappingBase<int>.fromJson(Map<String, dynamic>.from(json['endTime'] as Map)),
);

EventExtraScript _$EventExtraScriptFromJson(Map json) => EventExtraScript(
  huntingId: (json['huntingId'] as num?)?.toInt() ?? 0,
  raidLink:
      (json['raidLink'] as Map?)?.map((k, e) => MapEntry(const RegionConverter().fromJson(k as String), e as String)) ??
      const {},
);
...
SubSummon _$SubSummonFromJson(Map json) => SubSummon(
  ...
  probs:
      (json['probs'] as List<dynamic>?)?.map((e) => ProbGroup.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
);
