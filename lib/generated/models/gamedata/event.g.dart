...
Event _$EventFromJson(Map json) => Event(
  ...
  eventAdds:
      (json['eventAdds'] as List<dynamic>?)
  ...
  svts:
      ...
      const [],
  shop:
      (json['shop'] as List<dynamic>?)?.map((e) => NiceShop.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
  pointRewards:
  ...
  recipes:
      ...
      const [],
  bulletinBoards:
      (json['bulletinBoards'] as List<dynamic>?)
  ...
  campaigns:
      ...
      const [],
  campaignQuests:
      (json['campaignQuests'] as List<dynamic>?)
...
EventAdd _$EventAddFromJson(Map json) => EventAdd(
  overwriteType: $enumDecodeNullable(_$EventOverwriteTypeEnumMap, json['overwriteType']) ?? EventOverwriteType.unknown,
...
MstMasterMission _$MstMasterMissionFromJson(Map json) => MstMasterMission(
  ...
  gifts: (json['gifts'] as Map?)?.map((k, e) => MapEntry(int.parse(k as String), (e as num).toInt())) ?? const {},
...
const _$PurchaseTypeEnumMap = {
  ...
  PurchaseType.classBoardResetItem: 'classBoardResetItem',
...
NiceShop _$NiceShopFromJson(Map json) => NiceShop(
  ...
  consumes:
      ...
      const [],
  freeShopConds:
      (json['freeShopConds'] as List<dynamic>?)
  ...
  itemSet:
      (json['itemSet'] as List<dynamic>?)?.map((e) => ItemSet.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
  gifts: json['gifts'] == null ? const [] : const GiftsConverter().fromJson(json['gifts'] as List),
...
EventPointActivity _$EventPointActivityFromJson(Map json) => EventPointActivity(
  ...
  objectType:
      $enumDecodeNullable(_$EventPointActivityObjectTypeEnumMap, json['objectType']) ??
...
EventCommandAssist _$EventCommandAssistFromJson(Map json) => EventCommandAssist(
  ...
  name: json['name'] as String,
  assistCard: json['assistCard'] == null ? 0 : const CardTypeConverter().fromJson(json['assistCard']),
  image: json['image'] as String,
...
EventLotteryTalk _$EventLotteryTalkFromJson(Map json) => EventLotteryTalk(
  ...
  beforeVoiceLines:
      (json['beforeVoiceLines'] as List<dynamic>?)
          ?.map((e) => VoiceLine.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  afterVoiceLines:
      (json['afterVoiceLines'] as List<dynamic>?)
          ?.map((e) => VoiceLine.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
...
WarBoardStageSquare _$WarBoardStageSquareFromJson(Map json) => WarBoardStageSquare(
  ...
  treasures:
      (json['treasures'] as List<dynamic>?)
...
EventRewardScene _$EventRewardSceneFromJson(Map json) => EventRewardScene(
  ...
  flags:
      (json['flags'] as List<dynamic>?)?.map((e) => $enumDecode(_$EventRewardSceneFlagEnumMap, e)).toList() ?? const [],
);
...
EventVoicePlay _$EventVoicePlayFromJson(Map json) => EventVoicePlay(
  ...
  voiceLines:
      ...
      const [],
  confirmVoiceLines:
      (json['confirmVoiceLines'] as List<dynamic>?)
          ?.map((e) => VoiceLine.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
...
EventRecipe _$EventRecipeFromJson(Map json) => EventRecipe(
  ...
  closedMessage: json['closedMessage'] as String? ?? '',
  recipeGifts:
      (json['recipeGifts'] as List<dynamic>?)
...
EventFortificationDetail _$EventFortificationDetailFromJson(Map json) => EventFortificationDetail(
  ...
  name: json['name'] as String,
  className:
      $enumDecodeNullable(_$SvtClassSupportGroupTypeEnumMap, json['className']) ?? SvtClassSupportGroupType.notSupport,
  releaseConditions:
      (json['releaseConditions'] as List<dynamic>?)
          ?.map((e) => CommonRelease.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
...
EventBulletinBoardScript _$EventBulletinBoardScriptFromJson(Map json) =>
    EventBulletinBoardScript(icon: json['icon'] as String?, name: json['name'] as String?);
...
HeelPortrait _$HeelPortraitFromJson(Map json) =>
    HeelPortrait(id: (json['id'] as num).toInt(), name: json['name'] as String? ?? "", image: json['image'] as String);
