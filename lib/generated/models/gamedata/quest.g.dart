...
BasicQuest _$BasicQuestFromJson(Map json) => BasicQuest(
  ...
  flags:
      (json['flags'] as List<dynamic>?)?.map((e) => const QuestFlagConverter().fromJson(e as String)).toList() ??
      const [],
...
Quest _$QuestFromJson(Map json) => Quest(
  ...
  consume: (json['consume'] as num?)?.toInt() ?? 0,
  consumeItem:
      (json['consumeItem'] as List<dynamic>?)
  ...
  releaseConditions:
      ...
      const [],
  releaseOverwrites:
      (json['releaseOverwrites'] as List<dynamic>?)
  ...
  phasesWithEnemies: (json['phasesWithEnemies'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [],
  phasesNoBattle: (json['phasesNoBattle'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [],
  phaseScripts:
      (json['phaseScripts'] as List<dynamic>?)
...
QuestPhase _$QuestPhaseFromJson(Map json) => QuestPhase(
  ...
  phaseGifts:
      (json['phaseGifts'] as List<dynamic>?)?.map((e) => Gift.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
  ...
  messages:
      ...
      const [],
  hints:
      (json['hints'] as List<dynamic>?)?.map((e) => QuestHint.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
  restrictions:
      ...
      const [],
  supportServants:
      (json['supportServants'] as List<dynamic>?)
          ?.map((e) => SupportServant.fromJson(Map<String, dynamic>.from(e as Map)))
          .toList() ??
      const [],
  stages: (json['stages'] as List<dynamic>?)?.map((e) => Stage.fromJson(Map<String, dynamic>.from(e as Map))).toList(),
  drops:
      (json['drops'] as List<dynamic>?)?.map((e) => EnemyDrop.fromJson(Map<String, dynamic>.from(e as Map))).toList() ??
      const [],
);
...
Stage _$StageFromJson(Map json) => Stage(
  ...
  waveStartMovies:
      (json['waveStartMovies'] as List<dynamic>?)
...
AiAllocationInfo _$AiAllocationInfoFromJson(Map json) => AiAllocationInfo(
  ...
  applySvtType:
      (json['applySvtType'] as List<dynamic>?)
          ?.map(
            (e) => $enumDecode(_$AiAllocationApplySvtFlagEnumMap, e, unknownValue: AiAllocationApplySvtFlag.unknown),
          )
          .toList() ??
      const [],
...
StageStartMovie _$StageStartMovieFromJson(Map json) =>
    StageStartMovie(waveStartMovie: json['waveStartMovie'] as String);
...
SupportServantLimit _$SupportServantLimitFromJson(Map json) =>
    SupportServantLimit(limitCount: (json['limitCount'] as num).toInt());
...
QuestEnemy _$QuestEnemyFromJson(Map json) => QuestEnemy(
  ...
  originalEnemyScript: (json['originalEnemyScript'] as Map?)?.map((k, e) => MapEntry(k as String, e)),
  infoScript: json['infoScript'] == null
      ? null
      : EnemyInfoScript.fromJson(Map<String, dynamic>.from(json['infoScript'] as Map)),
  originalInfoScript: (json['originalInfoScript'] as Map?)?.map((k, e) => MapEntry(k as String, e)),
