...
FakerSettings _$FakerSettingsFromJson(Map json) => $checkedCreate('FakerSettings', json, ($checkedConvert) {
  final val = FakerSettings(
    ...
    apRecoveredAlarm: $checkedConvert('apRecoveredAlarm', (v) => v as bool? ?? false),
    ...
    animateProgressIndicator: $checkedConvert('animateProgressIndicator', (v) => v as bool? ?? true),
...
AutoBattleOptions _$AutoBattleOptionsFromJson(Map json) => $checkedCreate('AutoBattleOptions', json, ($checkedConvert) {
  final val = AutoBattleOptions(
    ...
    useEventSupport: $checkedConvert('useEventSupport', (v) => v as bool?),
    ...
    supportEquipMaxLimitBreak: $checkedConvert('supportEquipMaxLimitBreak', (v) => v as bool? ?? true),
    ...
    checkQuestCondition: $checkedConvert('checkQuestCondition', (v) => v as bool? ?? false),
    ...
    customAliveUniqueId: $checkedConvert('customAliveUniqueId', (v) => v as bool? ?? false),
...
Map<String, dynamic> _$AutoBattleOptionsToJson(AutoBattleOptions instance) => <String, dynamic>{
  ...
  'useEventSupport': instance.useEventSupport,
  ...
  'customAliveUniqueId': instance.customAliveUniqueId,
